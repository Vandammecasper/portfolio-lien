  ...
  return (
    <Header>
      ...
      <div className="w-screen bg-primary mt-24 overflow-hidden md:flex md:p-40 px-8 md:pr-12 lg:pr-20 xl:pr-56 py-8 2xl:py-48">
        <h1 className="text-white text-7xl sm:text-8xl md:text-9xl lg:text-9xl font-ivyMode font-black sm:font-bold md:-rotate-90 text-nowrap z-10 md:-ml-40 lg:-ml-48 xl:-ml-64 2xl:-ml-60">Over mij</h1>
        <div className="md:-ml-80 lg:-ml-64 xl:-ml-40 2xl:-ml-68 2xl:self-center max-md:pb-16">
      ...
      <img src="/portfolio_icon_white2.svg" alt="" className="absolute max-sm:h-48 max-lg:h-56 max-xl:h-72 right-0 -mt-32 md:mt-100 lg:mt-80 xl:mt-32 2xl:mt-32"/>
      </div>
