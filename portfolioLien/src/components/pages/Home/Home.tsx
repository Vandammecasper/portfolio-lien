    ...
    <Header>
      ...
      <div className="w-screen bg-primary mt-24 overflow-hidden md:flex md:p-40 px-8 md:pr-12 lg:pr-20 xl:pr-56 py-8 2xl:py-48">
        ...
        <div className="md:-ml-80 lg:-ml-56 xl:-ml-40 2xl:-ml-68 2xl:self-center max-md:pb-16">
          <p className="sm:text-lg lg:text-xl 2xl:text-2xl mt-6 lg:-mt-16">I am a 22-year-old <span className="font-bold">cross-media student</span> at Artevelde. I chose the specialisation ‘<span className="font-bold">Photo design</span>’. In this specialisation, we take all the photographs we use in our designs ourselves. The choice of Photo Design was an obvious one for me, as I have always had a strong interest in photography from a young age.</p>
