  ...
  return (
    <Header>
      ...
      <div className="w-screen bg-primary mt-24 overflow-hidden md:flex md:p-40 px-8 md:pr-12 lg:pr-20 xl:pr-56 py-8 2xl:py-48">
        <h1 className="text-white text-6xl sm:text-8xl md:text-9xl lg:text-10xl 2xl:text-11xl font-ivyMode font-bold md:-rotate-90 text-nowrap z-10 md:-ml-24 lg:-ml-40 xl:-ml-64 2xl:-ml-60">Over mij</h1>
