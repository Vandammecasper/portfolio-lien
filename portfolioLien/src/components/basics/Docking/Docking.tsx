...
const dockVariants = cva(
  "mx-auto w-max mt-8 h-[48px] flex gap-2 rounded-full drop-shadow-2xl border-primary supports-backdrop-blur:bg-white/10 supports-backdrop-blur:dark:bg-black/10 backdrop-blur-md",
);
